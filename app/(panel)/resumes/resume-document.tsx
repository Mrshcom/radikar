...
function ProjectSection({
  ...
  return (
    <section className={className}>
      <div className="mb-[1em]">{heading}</div>
      <ProjectEntries
        data={data}
        direction={direction}
      />
    ...
    >
      ...
      <div
        className={cn(
          ...
          templateId === "sector-yellow" ? "top-[1.34%]" : "top-0",
          theme.avatar,
        )}
      />
      {!continuation && (
        ...
        >
          ...
          <div className="min-w-0 flex-1 overflow-hidden">
            <h1 className="m-0 line-clamp-2 text-[2.3em] leading-tight">
              {data.fullName || "\u00a0"}
            </h1>
            <p
              className={cn(
    ...
    >
      ...
      {!continuation && (
        <header className="flex h-full items-center gap-[2.4em] border-b border-[#dce5df] px-[7%] py-[4.5%]">
          ...
          />
          <div className="min-w-0 flex-1 overflow-hidden">
            <h1 className="m-0 line-clamp-2 text-[2.3em] leading-tight text-[#19312f]">
              {data.fullName || "\u00a0"}
            </h1>
            <p
              className={cn(
  ...
  return (
    ...
    >
      {!continuation && (
        ...
        >
          <h1 className="m-0 truncate text-[2.35em] font-semibold leading-none tracking-[-.025em]">
            {data.fullName || "\u00a0"}
          </h1>
    ...
    >
      {!continuation && (
        <>
          ...
          >
            <h1 className="m-0 truncate text-[2.3em] font-bold">
              {data.fullName || "\u00a0"}
            </h1>
          </header>
      ...
      {!continuation && (
        <>
          ...
          >
            ...
            />
            <h1
              className="m-0 w-full min-w-0 break-words ps-[9.5em] text-center text-[2.3em] font-bold leading-[1.08] text-balance data-[long=true]:text-[1.55em]"
              data-long={24 < data.fullName.trim().length}
            >
              {data.fullName || "\u00a0"}
            </h1>
          </header>
