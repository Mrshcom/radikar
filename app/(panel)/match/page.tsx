  ...
  const tailorResume = async (
    ...
    try {
      ...
      if (!response.ok || !result.resume)
        throw new Error(result.error || "ساخت رزومه اختصاصی ناموفق بود.");
      const linkedJob = sourceJobId
        ...
        : (await jobStore.list()).find(
            (job) =>
              ...
              Boolean(
                prefilledSourceUrl && job.sourceUrl === prefilledSourceUrl,
              ),
          );
      ...
      const targetJobTitle =
        analyzedJobTitle &&
        !analyzedJobTitle.includes("مشخص نشده")
          ? analyzedJobTitle
      ...
      <div className="grid gap-4 min-[1121px]:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        <section className={panel}>
              ...
              return (
                ...
                >
                  ...
                  <span className="flex min-w-0 flex-1 flex-col gap-[3px]">
                    ...
                    <small className="truncate text-[7px] text-[#96a09e]">
                      {source.hint}
                    </small>
                  </span>
                  {active && (
          ...
          <div className="relative mt-4 grid gap-1.5" ref={resumePickerRef}>
            ...
            >
              ...
              <div className="flex min-w-0 flex-1 flex-col">
                ...
                <span className="mt-0.5 truncate text-[7px] text-[#929e9a]">
          ...
          <button
            ...
            disabled={
              !hasSelectedInput || !selectedResume || analyzing || importingUrl
            }
            onClick={analyze}
          >
            <Sparkles size={18} />{" "}
