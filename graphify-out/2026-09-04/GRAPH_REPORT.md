# Graph Report - resumeMaker  (2026-09-04)

## Corpus Check
- 164 files · ~226,348 words
...
Cohesion: 0.11
Nodes (22): JobCard(), JobCardData, JobDetailsData, JobDetailsModal(), JobLogo(), toneStyles, Job, JobTone (+14 more)
...
- **Why does `cn()` connect `resume-document.tsx` to `panel-shell.tsx`, `match/page.tsx`, `knowledge-base/page.tsx`, `stores.ts`, `parseResumeSkills`, `toast.tsx`, `loading-skeletons.tsx`, `admin/orders/page.tsx`, `jobs/page.tsx`, `jalali-date-picker.tsx`, `table-page-size.ts`?**
...
- **Why does `apiRequest()` connect `apiRequest` to `match/page.tsx`, `knowledge-base/page.tsx`, `DataCollection`, `stores.ts`, `useAuth`, `memberships/page.tsx`, `admin/orders/page.tsx`, `admin-stats.ts`, `dashboard/page.tsx`, `panel-shell.tsx`, `table-page-size.ts`?**
